...
<div class="card card-body theme-card-light mt-5">
    ...
    <form action="<?php echo URLROOT; ?>/customers/add" method="post" data-verify="customer"
        data-verify-redirect="<?php echo URLROOT; ?>/customers">
...
<script>
    // Auto-formatting for customer form
