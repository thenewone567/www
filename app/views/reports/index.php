    ...
    <div class="row">
        ...
        <div class="col-md-6 col-lg-4 mb-4">
            <div class="card h-100">
                ...
                <div class="card-body">
                    <p class="card-text">Monitor stock levels and inventory movement.</p>
                    <div class="d-grid gap-2">
                        <a href="<?php echo URLROOT; ?>/reports/inventory" class="btn btn-warning btn-lg">
                            <i class="fa-solid fa-boxes"></i> Stock Reports
                        </a>
                        <a href="<?php echo URLROOT; ?>/reports/stockalerts" class="btn btn-outline-warning">
                            <i class="fa-solid fa-exclamation-triangle"></i> Stock Alerts
                        </a>
                    </div>
                </div>
            </div>
