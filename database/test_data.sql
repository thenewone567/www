-- Test Data for Hardware Store Management System
-- This script adds sample data to test dashboard functionality
...
-- Insert Categories (without description field)
...
-- Insert Brands (without description field)
...
-- Insert Units (without abbreviation field)
...
-- Insert Suppliers (without address field, with gst_info and due_amount)
...
ALTER TABLE `units` AUTO_INCREMENT = 9;
ALTER TABLE `suppliers` AUTO_INCREMENT = 6;
ALTER TABLE `customers` AUTO_INCREMENT = 9;
ALTER TABLE `products` AUTO_INCREMENT = 21;
ALTER TABLE `stock` AUTO_INCREMENT = 21;
ALTER TABLE `sales` AUTO_INCREMENT = 21;
ALTER TABLE `sale_items` AUTO_INCREMENT = 55;
ALTER TABLE `purchases` AUTO_INCREMENT = 8;
ALTER TABLE `purchase_items` AUTO_INCREMENT = 23;
ALTER TABLE `activity_logs` AUTO_INCREMENT = 9;
